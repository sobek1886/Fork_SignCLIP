...
form-neighbour / iconicity glosses across spaces, so all those figures can be
re-plotted locally (t-SNE, offset arrows, offset quiver) with no cluster."""
...
SPACES = {"raw": "logos_features_native",
          "pair_k3": "signclip_features_pair_k3",
          "pair_k5": "signclip_features_pair_k5"}
